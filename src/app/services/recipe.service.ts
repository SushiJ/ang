...
export class RecipeService {
  ...
  recipes: Array<Recipe> = [
    ...
    new Recipe(
      'Fruit Tart',
      'These 4-ingredient fruit tarts are quick and easy to make. You can use most fruit, e.g. pears, apples, peaches, or nectarines. Serve warm with vanilla ice cream or sugar glaze if desired.',
      'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fpublic-assets.meredithcorp.io%2F3f5ab65811a5296c33546022df31c59f%2F1683939726398Easy-4-Ingredient-Fruit-Tarts.jpg&q=60&c=sc&orient=true&poi=auto&h=512',
      [
